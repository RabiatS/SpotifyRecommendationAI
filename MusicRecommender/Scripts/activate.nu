...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Michael Nootbaar\Documents\Workspaces\AIMusicRecommender\MusicRecommender'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Michael Nootbaar\Documents\Workspaces\AIMusicRecommender\MusicRecommender\Scripts\deactivate.nu'
